...
public class Main {
    public static void main(String[] args) {
        int dungeonSize = 3; // Distance from center to edge
        
        // 1. Generate the dungeon (Update generate to return the Map!)
        Map<DungeonGenerator.Coord, Room> dungeon = DungeonGenerator.generate(dungeonSize);
        ...
        for (int y = dungeonSize; y >= -dungeonSize; y--) {
            ...
            for (int x = -dungeonSize; x <= dungeonSize; x++) {
                ...
                if (r == null) {
                    ...
                    line2.append(r.isWest() ? "-" : "#").append(" R ").append(r.isEast() ? "-" : "#");
